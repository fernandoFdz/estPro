...
/**
 * Created by Ferykudou  on 11/11/2017.
 */
...
public class MyAlarmReceiver extends BroadcastReceiver {
    ...
    private void triggerNotification(Context contexto, String t) {
        Intent notificationIntent = new Intent(contexto, MenuPrincipal.class);
        ...
        builder.setContentIntent(contentIntent)
                ...
                .setContentText(t)
                .setContentInfo("Info")
                .setLargeIcon(BitmapFactory.decodeResource(contexto.getResources(), R.drawable.icono_not))
